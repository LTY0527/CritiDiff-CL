# Table S1. Recent time-series baselines under the unified five-seed extension

> Post-hoc evidence (not preregistered); Track A = shared-backbone mechanism adaptation; Track B = method-native representation context
...
Source: `exp/posthoc-baseline-expansion:docs/posthoc_recent_baselines_5seed.md`. Values are copied verbatim; no statistics were recomputed.
